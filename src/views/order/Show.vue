                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <button class="btn btn-primary" @click="payment(detailOrder.snap_token)" v-if="detailOrder.status == 'pending'">BAYAR SEKARANG</button>
                                    <button class="btn btn-success" v-else-if="detailOrder.status == 'success'">{{ detailOrder.status }}</button>
                                    <button class="btn btn-warning" v-else-if="detailOrder.status == 'expired'">{{ detailOrder.status }}</button>
                                    <button class="btn btn-danger" v-else-if="detailOrder.status == 'failed'">{{ detailOrder.status }}</button>
                                </td>
                            </tr>
                        </table>
                    </div>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            return {
                store, route, router, detailOrder, productInOrder, payment
            }
        }
    }
</script>