            ...
            <div class="col-md-3 col-6 mb-3" v-for="product in products" :key="product.id">
                <div class="card h-100 border-0 shadow rounded-md">
                    ...
                    <div class="card-body">
                        ...
                        <div class="discount mt-2" v-if="product.discount != 0" style="color:#999">
                            <s>Rp. {{ moneyFormat(product.price) }}</s> <span class="badge badge-pill badge-success text-white">DISKON {{ product.discount }} %</span>
                        </div>
