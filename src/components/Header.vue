                    ...
                    <div class="col-md-5 d-none d-md-block">
                        <form class="search-wrap">
                            <div class="input-group w-100">
                                <input type="text" name="q" class="form-control search-form" placeholder="Mau beli apa hari ini?" style="width:55%;border:1px solid #ffffff;">
                    ...
                    <div class="col-md-4 col-5">
                        <div class="d-flex justify-content-end">
                            <div class="cart-header">
                                <router-link :to="{name: 'cart'}" class="btn search-button btn-md" style="color:#ffffff;background-color:#6677ef;border-color:#ffffff;">
...
<script>
    ...
    export default {
        setup() {
            ...
            return {
                store, isLoggedIn, cartTotal, cartCount
            }
        }
    }
</script>