<template>
    <footer class="pt-5" style="background:#ffffff;border-top:5px solid #6677ef;">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p>
                        ...
                        <br>
                        Senin - Minggu ( 07.00 WIB s/d 16.00 WIB )
                    </p>
                    <p>
                        <i class="fa fa-map-marker"></i> Perumahan Puri Kratau Hijau, Blok B3 No. 37, Kotasari, Gerogol, Kota Cilegon, Banten, 42162
                    </p>
                </div>
            </div>
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr>
                    &copy; <strong>Online Shop</strong> 2020 • Hak Cipta Dilindungi
                </div>
            </div>
        </div>
    </footer>
